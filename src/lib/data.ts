...
const FIRST_NAMES = ['Aarav', 'Vivaan', 'Aditya', 'Vihaan', 'Arjun', 'Sai', 'Reyansh', 'Ayaan', 'Krishna', 'Ishaan', 'Ananya', 'Diya', 'Saanvi', 'Aadhya', 'Pari', 'Riya', 'Myra', 'Aarohi', 'Isha', 'Prisha', 'Liam', 'Olivia', 'Noah', 'Emma', 'Oliver', 'Ava', 'Elijah', 'Charlotte', 'William', 'Sophia'];
...
const generateEmployees = (count: number): Employee[] => {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    employees.push({
      ...
      usualPunchIn: '09:30',
      usualPunchOut: '18:30',
      leaveBalance: Math.floor(Math.random() * 15) + 5, // More realistic balance
...
export const mockEmployees: Employee[] = generateEmployees(250);
